  ...
  { 
    ...
    getApp().request({  //请求服务器上的 API: get /user
      ...
      console.log(res)
        ...
        getApp().globalData.userInfo.email = res.data.email;
        ...
        that.setData({ email: getApp().globalData.userInfo.email });
      }
  ...
  postinfor: function ()
{
   ////先将新edit的数据先修改到本地数据
    ...
    getApp().globalData.userInfo.email = this.tempdata.email;
    ...
    this.setData({ email: getApp().globalData.userInfo.email });
...
tempdata:{
 ...
 changeintro: function (e) {
  ...
  changeemail: function (e) {
    this.tempdata.email = e.detail.value.trim();
